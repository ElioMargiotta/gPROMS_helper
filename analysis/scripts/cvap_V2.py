...
VARIABLES_TO_COMPARE = [
    'Plant.Absorber.Stage(23).C_vap_I("H2O")',
    'Plant.Absorber.Stage(23).C_liq_I("H2O")',
    'Plant.Absorber.Stage(23).C_vap_I("CO2")',
    'Plant.Absorber.Stage(23).C_liq_I("CO2")',
    'Plant.Absorber.Stage(23).C_vap_I("N2")',
    'Plant.Absorber.Stage(23).C_liq_I("N2")',
    'Plant.Absorber.Stage(23).C_vap_out("H2O")',
    'Plant.Absorber.Stage(23).C_liq_out("H2O")',
    'Plant.Absorber.Stage(23).C_vap_out("CO2")',
    'Plant.Absorber.Stage(23).C_liq_out("CO2")',
    'Plant.Absorber.Stage(23).C_vap_out("N2")',
    'Plant.Absorber.Stage(23).C_liq_out("N2")',
    'Plant.Absorber.Stage(23).kvap("H2O")',
    'Plant.Absorber.Stage(23).kvap("CO2")',
    'Plant.Absorber.Stage(23).kvap("N2")',
    'Plant.Absorber.Stage(23).kliq("H2O")',
    'Plant.Absorber.Stage(23).kliq("CO2")',
    'Plant.Absorber.Stage(23).kliq("N2")',
]
...
COMPOSITE_COMPARISONS = {
    'Plant.Absorber.Stage(23).C_vap_I_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(23).C_vap_I("ABSORBENT_1")',
            'Plant.Absorber.Stage(23).C_vap_I("ABSORBENT_2")'
        ],
        "file2_var": 'Plant.Absorber.Stage(23).C_vap_I("ABSORBENT_1")'
    },
    'Plant.Absorber.Stage(23).C_liq_I_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(23).C_liq_I("ABSORBENT_1")',
            'Plant.Absorber.Stage(23).C_liq_I("ABSORBENT_2")',
        ],
        "file2_var": 'Plant.Absorber.Stage(23).C_liq_I("ABSORBENT_1")'
    },
    'Plant.Absorber.Stage(23).C_vap_out_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(23).C_vap_out("ABSORBENT_1")',
            'Plant.Absorber.Stage(23).C_vap_out("ABSORBENT_2")',
        ],
        "file2_var": 'Plant.Absorber.Stage(23).C_vap_out("ABSORBENT_1")'
    },
    'Plant.Absorber.Stage(23).C_liq_out_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(23).C_liq_out("ABSORBENT_1")',
            'Plant.Absorber.Stage(23).C_liq_out("ABSORBENT_2")',
        ],
        "file2_var": 'Plant.Absorber.Stage(23).C_liq_out("ABSORBENT_1")'
    },
    'Plant.Absorber.Stage(23).kliq_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(23).kliq("ABSORBENT_1")',
        ],
        "file2_var": 'Plant.Absorber.Stage(23).kliq("ABSORBENT_1")'
    },
    'Plant.Absorber.Stage(23).kvap_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(23).kvap("ABSORBENT_1")',
        ],
        "file2_var": 'Plant.Absorber.Stage(23).kvap("ABSORBENT_1")'
    }
}
...
def write_comparison_csv(outdir: str, file1: str, file2: str, 
    ...
    out_csv = os.path.join(outdir, "cvap_V2.csv")
...
def plot_percentage_differences(outdir: str, file1: str, file2: str,
    ...
    out_png = os.path.join(outdir, "cvap_V2.png")
