...
VARIABLES_TO_COMPARE = [
    'Plant.Absorber.Lqd_in.mole_fraction("H2O")',
    'Plant.Absorber.Lqd_in.mole_fraction("CO2")',
    'Plant.Absorber.Lqd_in.mole_fraction("N2")',
    'Plant.Absorber.Lqd_in.temperature',
    'Plant.Absorber.Lqd_in.pressure',
    'Plant.Absorber.Lqd_in.flowrate',
    'Plant.Absorber.Vpr_in.mole_fraction("H2O")',
    'Plant.Absorber.Vpr_in.mole_fraction("CO2")',
    'Plant.Absorber.Vpr_in.mole_fraction("N2")',
    'Plant.Absorber.Vpr_in.temperature',
    'Plant.Absorber.Vpr_in.pressure',
    'Plant.Absorber.Vpr_in.flowrate',
]
...
COMPOSITE_COMPARISONS = {
    "Plant.Absorber.Lqd_in.mole_fraction_total_abs": {
        "file1_vars": [
            'Plant.Absorber.Lqd_in.mole_fraction("ABSORBENT_1")',
            'Plant.Absorber.Lqd_in.mole_fraction("ABSORBENT_2")'
        ],
        "file2_var": 'Plant.Absorber.Lqd_in.mole_fraction("ABSORBENT_1")'
    },
    "Plant.Absorber.Vpr_in.mole_fraction_total_abs": {
        "file1_vars": [
            'Plant.Absorber.Vpr_in.mole_fraction("ABSORBENT_1")',
            'Plant.Absorber.Vpr_in.mole_fraction("ABSORBENT_2")'
        ],
        "file2_var": 'Plant.Absorber.Vpr_in.mole_fraction("ABSORBENT_1")'
    }
...
def write_comparison_csv(outdir: str, file1: str, file2: str, 
    ...
    out_csv = os.path.join(outdir, "Inputs_differences.csv")
...
def plot_percentage_differences(outdir: str, file1: str, file2: str,
    ...
    out_png = os.path.join(outdir, "Inputs_differences.png")
