...
VARIABLES_TO_COMPARE = [
    "Plant.Absorber.Stage(1).trans_prop.T_melt_mixture",
    'Plant.Absorber.Stage(1).trans_prop.stg_pressure',
    'Plant.Absorber.Stage(1).trans_prop.stg_temp_C_liq',
    'Plant.Absorber.Stage(1).trans_prop.stg_temp_C_vap',
    'Plant.Absorber.Stage(1).trans_prop.stg_temp_C_int',
    'Plant.Absorber.Stage(1).trans_prop.loading_CO2',
...
COMPOSITE_COMPARISONS = {
    #"Plant.recycle_solvent.out.mole_fraction_total_abs": {
        #"file1_vars": [
            #'Plant.recycle_solvent.out.mole_fraction("ABSORBENT_1")',
            #'Plant.recycle_solvent.out.mole_fraction("ABSORBENT_2")'
        #],
        #"file2_var": 'Plant.recycle_solvent.out.mole_fraction("ABSORBENT_1")'
    #},
...
def write_comparison_csv(outdir: str, file1: str, file2: str, 
    ...
    out_csv = os.path.join(outdir, "stage(1)_properties_comparison.csv")
...
def plot_percentage_differences(outdir: str, file1: str, file2: str,
    ...
    out_png = os.path.join(outdir, "proprierties.png")
