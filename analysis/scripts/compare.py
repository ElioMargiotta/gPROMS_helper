...
VARIABLES_TO_COMPARE = [
    "Plant.makeup_solvent_flowrate",
    "Plant.loading_rich", 
    "Plant.solvent_rate",
    "Plant.Amine_charge_ini",
    "Plant.Cost_CAPEX",
    "Plant.Cost_OPEX",
    "Plant.Cost_LCCC_total",
    "Plant.Objective_CCS",
    "Plant.Absorber.Stage(1).DZ",
    "Plant.Absorber.Stage(1).A",
    "Plant.Absorber.Stage(1).a_p",
    "Plant.Absorber.Stage(1).a_T",
    "Plant.Absorber.Stage(1).a_e",
    'Plant.Absorber.H_rate_based_total'
]
...
def write_comparison_csv(outdir: str, file1: str, file2: str, 
    ...
    out_csv = os.path.join(outdir, "variables_comparison.csv")
...
def plot_percentage_differences(outdir: str, file1: str, file2: str,
    ...
    out_png = os.path.join(outdir, "variables_percentage_differences.png")
