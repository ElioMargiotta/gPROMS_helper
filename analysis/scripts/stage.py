...
VARIABLES_TO_COMPARE = [
    "Plant.Absorber.Stage(1).T_I",
    'Plant.Absorber.Stage(1).h_T_liq',
    'Plant.Absorber.Stage(1).h_T_vap',
    'Plant.Absorber.Stage(1).H_vaporisation("H2O")',
    'Plant.Absorber.Stage(1).H_vaporisation("N2")',
    'Plant.Absorber.Stage(1).H_vaporisation("CO2")',
    'Plant.Absorber.Stage(1).trans_prop.SurfaceTension_EP_mixture',
    'Plant.Absorber.Stage(1).trans_prop.Viscosity_liq_mixture',
    'Plant.Absorber.Stage(1).trans_prop.Viscosity_vap_mixture',
    'Plant.Absorber.Stage(1).trans_prop.Viscosity_liq_H2O',
    'Plant.Absorber.Stage(1).N_Re',
    'Plant.Absorber.Stage(1).N_Fr',
    'Plant.Absorber.Stage(1).N_We',
    'Plant.Absorber.Stage(1).N_spec_liq("H2O")',
    'Plant.Absorber.Stage(1).N_spec_vap("H2O")',
    'Plant.Absorber.Stage(1).N_spec_liq("CO2")',
    'Plant.Absorber.Stage(1).N_spec_vap("CO2")',
    'Plant.Absorber.Stage(1).N_spec_liq("N2")',
    'Plant.Absorber.Stage(1).N_spec_vap("N2")',
]
...
COMPOSITE_COMPARISONS = {
    'Plant.Absorber.Stage(1).H_vaporisation_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(1).H_vaporisation("ABSORBENT_1")',
        ],
        "file2_var": 'Plant.Absorber.Stage(1).H_vaporisation("ABSORBENT_1")'
    },
        'Plant.Absorber.Stage(1).N_spec_liq_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(1).N_spec_liq("ABSORBENT_1")',
            'Plant.Absorber.Stage(1).N_spec_liq("ABSORBENT_2")'
        ],
        "file2_var": 'Plant.Absorber.Stage(1).N_spec_liq("ABSORBENT_1")'
    },
    'Plant.Absorber.Stage(1).N_spec_vap_total_abs': {
        "file1_vars": [
            'Plant.Absorber.Stage(1).N_spec_vap("ABSORBENT_1")',
            'Plant.Absorber.Stage(1).N_spec_vap("ABSORBENT_2")'
        ],
        "file2_var": 'Plant.Absorber.Stage(1).N_spec_vap("ABSORBENT_1")'
    },
    
    
    # Add more composite comparisons here as needed
    # "Another_composite": {
    #     "file1_vars": ["Plant.var1", "Plant.var2"],
    #     "file2_var": "Plant.combined_var"
    # }
}
...
def write_comparison_csv(outdir: str, file1: str, file2: str, 
    ...
    out_csv = os.path.join(outdir, "stage(1).csv")
...
def plot_percentage_differences(outdir: str, file1: str, file2: str,
    ...
    out_png = os.path.join(outdir, "stage(1).png")
